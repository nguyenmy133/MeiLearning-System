...
export function ProfilePage() {
  ...
  const [profile, setProfile] = useState<UserProfileInfo | undefined>(undefined);
  const [editedProfile, setEditedProfile] = useState<UserProfileInfo | undefined>(undefined);

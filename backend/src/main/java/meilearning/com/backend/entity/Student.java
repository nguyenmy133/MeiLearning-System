/**
 * Entity: Học viên — mở rộng từ User (1:1 qua user_id).
 * Chứa thông tin nghiệp vụ riêng của học viên.
 */
...
import meilearning.com.backend.entity.enums.Gender;
import meilearning.com.backend.entity.enums.StudentStatus;

/**
 * Entity: Lớp học.
 * schedule được lưu dạng JSON column (SessionSlot[]).
 *
 * Lưu ý: Tên class Java là ClassEntity vì "Class" là reserved word trong Java.
 * Table name vẫn là "classes".
 */
...
public class ClassEntity extends BaseEntity {
    ...
    /**
     * Lịch học dạng JSON: [{"weekday":1,"startTime":"18:00","endTime":"20:00"},
     * ...]
     */

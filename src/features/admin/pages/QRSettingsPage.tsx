...
export function QRSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-display font-bold mb-2">Cấu hình QR điểm danh</h1>
        <p className="text-muted-foreground">Thiết lập các tham số cho hệ thống điểm danh QR</p>
      </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setSettings({ ...settings, expiryTime: parseInt(e.target.value) || 5 })}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setSettings({ ...settings, lateThreshold: parseInt(e.target.value) || 10 })}
              className="max-w-[200px]"
            />
            <p className="text-sm text-muted-foreground">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-accent/50">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => setSettings({ ...settings, allowRegenerate: checked })}
            />
          </div>
